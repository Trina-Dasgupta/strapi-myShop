    ...
    <div className='container'>
      <header className="text-gray-600 body-font">
        ...
        <span className="ml-3 text-xl">MyShop</span>
          ...
          <button className="my-2 text-white bg-indigo-500 border-0 py-1 md:py-2 px-4 md:px-4 focus:outline-none hover:bg-indigo-600 rounded text-<Link></Link>sm">Login</button>
        </div>
      </header>
    </div>
  );
